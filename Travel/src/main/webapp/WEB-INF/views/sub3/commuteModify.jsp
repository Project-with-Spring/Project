	      ...
	      <div id="add_new" class="col-sm-12 col-md-12 col-lg-12">
	      	<form method="post" action="positionModifyPro" class="form-horizontal" name="positionModyForm" id="positionModyForm" style="width: 50%;margin: 0 auto;">
		          	...
		          	<div class="form-group">
						  ...
						  <div class="col-md-6">
						  	<input type="text" name="pst_id" id="pst_id" value="${commuteBean.cmt_go}" class="form-control required"></div>
					  </div>
					  <div class="form-group">
						  ...
						  <div class="col-md-6">
						  <c:choose>							
							    <c:when test="${commuteBean.cmt_leave != null} ">
						        	<input type="text" name="pst_name" id="pst_name" value="${commuteBean.cmt_leave} " class="form-control required" readonly="readonly">
							    </c:when>							
							    <c:otherwise>
						        	<input type="text" name="pst_name" id="pst_name" value="${commuteBean.cmt_leave} " class="form-control required" >
							    </c:otherwise>
