		...
		<div class="box">
			<div class="box-header with-border">
				...
				<div class="box-tools pull-right">
					...
					<a href="javascript:add_new();" class="btn btn-success btn-sm"><i
						class="fa fa-plus"></i> Add New ( 상품 / 재고 ) </a>
				</div>
				<!-- <script>
		function print_opt()
		{
			...
			<div class="box-body">
				...
				<div id="add_new" class="col-sm-12 col-md-12 col-lg-12"
					style="display: none;">
					<form method="POST" action="카테고리 추가 url" class="form-horizontal"
			...
			재고(2) 선택시 커피원두, 냉장/냉동, 차, 시럽/소스, 기타 -->
				...
				<div id="add-new-btn" style="display: none;">
					...
					<div class="col-xs-6 col-sm-2">
						<input type="button"
							class="form-control btn btn-success btn-sm btn-submit"
				...
				<div class="table-responsive no-padding">
					<table class="table table-striped table-responsive tbl_narrow">
						...
						<tr>
							...
							<td></td>
							<td></td>
							<td><a href="상품 업데이트 url"
								class="btn btn-default btn-xs" title="Update Detail">
